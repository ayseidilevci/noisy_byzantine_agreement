...
class FaultySender(Program):
    ...
    def __init__(self, M: int = 12, mu: float = 0.272, lambda_: float = 0.94, p0: float = 0.05, p1: float = 0.005):
        self.M = M
        self.mu = mu
    ...
    def run(self, context: ProgramContext):
        ...
        for i in range(self.M):
            ...
            if outcome0 == 0 and random.random() < self.p0:
                outcome0 = 1 - outcome0
            elif outcome0 == 1 and random.random() < self.p1:
                outcome0 = 1 - outcome0

            if outcome1 == 0 and random.random() < self.p0:
                outcome1 = 1 - outcome1
            elif outcome1 == 1 and random.random() < self.p1:
                outcome1 = 1 - outcome1

            outcome_pair = (int(outcome0), int(outcome1))
            measurements.append(outcome_pair)
...
class Receiver0(Program):
    ...
    def __init__(self, name: str, M: int = 12, mu: float = 0.272, p0: float = 0.05, p1: float = 0.005):
        self.name = name
        self.M = M
        self.mu = mu
        self.p0 = p0
...
class Receiver1(Program):
    ...
    def __init__(self, name: str, M: int = 12, mu: float = 0.272, lambda_: float = 0.94, p0: float = 0.05,
                 p1: float = 0.005):
        self.name = name
        self.M = M
        self.mu = mu
